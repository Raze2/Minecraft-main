    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-productOrders">
                    <thead>
                        <tr>
                            <th width="10">
...
<script>
  ...
  let table = $('.datatable-productOrders:not(.ajaxTable)').DataTable({ buttons: dtButtons })
