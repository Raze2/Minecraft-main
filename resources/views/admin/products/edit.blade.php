...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.update", [$product->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="package">{{ trans('cruds.product.fields.package') }}</label>
                <input class="form-control {{ $errors->has('package') ? 'is-invalid' : '' }}" type="number" name="package" id="package" value="{{ old('package', $product->package) }}" step="1" required>
                @if($errors->has('package'))
                    <span class="text-danger">{{ $errors->first('package') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.product.fields.package_helper') }}</span>
            </div>
            <div class="form-group">
                <label class="required">{{ trans('cruds.product.fields.category') }}</label>
