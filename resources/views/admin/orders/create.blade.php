    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.orders.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('product_quantity') ? 'is-invalid' : '' }}" type="number" name="product_quantity" id="product_quantity" value="{{ old('product_quantity', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('order_price') ? 'is-invalid' : '' }}" type="number" name="order_price" id="order_price" value="{{ old('order_price', '') }}" step="0.01" required>
