    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.content-pages.update", [$contentPage->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input class="form-control {{ $errors->has('title_ar') ? 'is-invalid' : '' }}" type="text" name="title_ar" id="title_ar" value="{{ old('title_ar', $contentPage->title_ar) }}">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('page_text_ar') ? 'is-invalid' : '' }}" name="page_text_ar" id="page_text_ar">{!! old('page_text_ar', $contentPage->page_text_ar) !!}</textarea>
